...
<html lang="en">
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li><a href="#">Home</a></li>
	     <li class="active"><a href="student_search.php">Search</a></li>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" name="fromdate" placeholder="Select Register From Date" value="<?php if(isset($_COOKIE['fromdate']))echo $_COOKIE['fromdate']; ?>" >
    </div>
    ...
    <div class="col-sm-3">
      <select class="form-control" name="completestatus" id="completestatus">				                
	  	...
	  	foreach($complete_status as $key => $value){
		   if($value["uid"] == htmlspecialchars($_SESSION["work_section"])){
    ...
    <div class="col-sm-4">
      <select class="form-control" name="scholarship" id="scholarship">				                
       		<option value="">Select Student Type</option>
       		<option value="16" <?php if(isset($_COOKIE['scholarship'])){if($_COOKIE['scholarship'] == 16) echo 'selected'; } ?>>?????</option>
