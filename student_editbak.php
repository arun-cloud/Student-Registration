	...
	if($result){
		...
		if ($return["pendingfees"] == 0){
			if ($return["nationality"] == "Saudi"){
				$_POST['content'] = "Greetings, Your registration was examined.Please report to finance dept. to pay the semesterfees fees:".$return["grandtotal"]." SR within 48Hrs.";
			}else{
				$_POST['content'] = "Greetings, Your registration was examined.Please report to finance dept. to pay the semesterfees fees:".$return["grandtotal"]." SR(Incl VAT 5%) within 48Hrs.";
			}
    ...
    <div class="col-sm-2">
	 ...
	 <div class="form-group">		
		 <div class="checkbox col-sm-offset-1">
		   	...
		   	<input type="checkbox" id="noobjection" name="noobjection" <?php if(isset($_POST['noobjection'])){ if($_POST['noobjection'] == "Y") echo "checked"; }  ?> value="Y"  />No objection to register the student in the study year 2018
		   	</label> &nbsp;&nbsp;
		</div>		  
    </div>
