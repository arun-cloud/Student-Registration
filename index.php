...
<html lang="en">
  <head>
    ...
    <meta name="description" content="IBN Sina Student Registration 2018-2019">
...
<a href='reg_ar.pdf' target='_blank' class="alert-link" >طريقة التسجيل</a>
  ...
  <div class="form-group">
   ...
   <div class="col-sm-2">
      <input type="text" class="form-control" id="year" name="year" value="2019" disabled>
    </div>
...
<select class="show-tick form-control" name="add_subjects[]" id="add_subjects" data-size="10" data-live-search-placeholder="Search" title="Select Subject" multiple disabled></select>
 ...
 <div class="alert alert-danger" role="alert">
  ...
  <span class="sr-only">Error:</span>
   ...
   I'm the student,my data shown above requesting the registration in the first semester for the study year 2018/2019.<br />
I acknowledge the validity of my above mentioned information and the college has the right to cancel my request if it is proved otherwise and I promise to pay the fees within 3 days and to complete the registration. The college has the right to stop me from studying in case of non-payment of fees</p>
      ...
      <div class="text-left" id="savecontainer">
        <h1>Thank You,</h1>
        <h2>Your registration will be processed.<br /> You will be informed about the status of your registration by given <b>SMS</b></h2>        
        <p><a class="btn btn-lg btn-primary" href="register.php" role="button">New Registeration</a></p>
      </div>
      ...
      <footer class="footer">
        <p>&copy; 2015-2019 Arun, Software Head.</p>
      </footer>
